    ...
    <div className="flex flex-col flex-grow p-4 bg-black rounded-lg opacity-80 text-white-default">
      ...
      {isScrolledUp && (
        <div className="relative flex justify-center">
          <button onClick={scrollToBottom} className="absolute z-50 cursor-pointer bottom-2">
            <ArrowDownIcon className="p-2 transition-all bg-gray-500 rounded-full size-10 text-white-default hover:opacity-100 hover:bg-gray-600 animate-bounce" />
          </button>
        </div>
      )}
      <input
